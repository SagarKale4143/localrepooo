...
public class PriorityQueueExample {
	...
	public static void main(String args[]) {
		...
		//element() returns top most element of the queue, if the queue if empty dn it will throw an exception by name 'NoSuchElementException'
		System.out.println("head element of the queue:" + queue.element());
		//peek() returns top most element of the queue, if the queue if empty dn it will return 'null' instead of throwing exception
		...
		System.out.println("Eleements of Queue: "+queue);
		//it will remove top most element of the Queue, if the queue is empty dn it will throw an exception by name 'NoSuchElementException'
		System.out.println("removing element from Queue using remove(): "+ queue.remove());//10
		System.out.println("Eleements of Queue: "+queue);
		//it will remove top most element of the Queue, if the queue is empty dn it will return 'null' value
